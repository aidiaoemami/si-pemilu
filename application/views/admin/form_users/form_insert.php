                ...
                <div class="container">
                  <form action="<?= base_url('admin/proses_tambah_user') ?>" role="form" method="post">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group" style="display:block;">
                        <label for="nama" style="width:87%;margin-left: 0px;">Nama Instansi</label>
                        <input type="text" name="nama" style="width: 30%;margin-right: 67px;margin-left: 0px;" class="form-control" id="nama" placeholder="Nama Instansi">
                      </div>
                      <div class="form-group" style="display:block;">

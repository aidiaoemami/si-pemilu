...
<div class="wrapper">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="id_transaksi" style="margin-left:220px;margin-right:78px;display:inline;">ID Transaksi</label>
 ...
 -->             
                <div class="form-group" style="margin-bottom:20px;">
                  <label for="nama_instansi" style="margin-left:220px;display:inline;margin-right: 27px;">Nama Instansi</label>
                  <select class="form-control" name="nama_instansi" style="margin-left:75px;width:20%;display:inline;">
                    <option value="" selected="">-- Pilih --</option>
                    <?php foreach($list_user as $s){ ?>
                ...
                <div class="form-group" style="margin-bottom:40px;">
                  <label for="nama_barang" style="margin-left:220px;display:inline;">Lokasi Asal Barang</label>
              ...
              <div class="form-group" style="display:inline-block;">
                <label for="jumlah" style="width:73%;margin-left:33px;">Jumlah Barang</label>
            ...
            <div class="form-group" style="display:inline-block;">
              ...
              <!-- /.box-body -->
               <div class="box-footer" style="">
                  <label for="barang_butuh" style="width:73%;">Barang Yang Dibutuhkan</label>
                  <!-- <input type="text" name="nama_barang" style="width:90%;margin-right: 67px;" class="form-control" id="nama_Barang" placeholder="Nama Barang"> -->
                  <select class="form-control" name="barang_butuh" style="width:20%;margin-right: 18px;">
                    <option value="" selected="">-- Pilih --</option>
                    <?php foreach($list_barangproduksi as $s){ ?>
                    <option value="<?=$s->nama_barangproduksi?>"><?=$s->nama_barangproduksi?></option>
                    <?php } ?>
                  </select>

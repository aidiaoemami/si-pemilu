...
<head>
  ...
  <title>Si-Iventory | Edit Barang Produksi</title>
          ...
          <div class="col-md-12">
            <div class="container">
              ...
              <div class="box box-primary" style="width:94%;">
                ...
                <!-- form start -->
                <div class="container">
                  <form action="<?= base_url('admin/proses_barangproduksi_update') ?>" role="form" method="post">
                    ...
                    <div class="box-body">
                      <div class="form-group">
                        <?php foreach ($data_barangproduksi as $d) { ?>
                          <div class="box-body">
                            <div class="form-group" style="display:inline-block;">
                              <input type="hidden" name="id_barangproduksi" value="<?= $d->id_barangproduksi ?>"> <label for="kode_satuan" style="width:87%;margin-left: 12px;">Kode Barang Produksi</label>
                              <input type="text" required name="kode_barangproduksi" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="kode_satuan" placeholder="Kode Barang Produksi" value="<?= $d->kode_barangproduksi ?>">
                            </div>
                            <div class="form-group" style="display:inline-block;">
                              <label for="nama_barangproduksi" style="width:73%;">Nama Barang Produksi</label>
                              <input type="text" required name="nama_barangproduksi" style="width:90%;margin-right: 67px;" class="form-control" id="nama_barangproduksi" placeholder="Nama Barang Produksi" value="<?= $d->nama_barangproduksi ?>">
                            </div>
                            <div class="form-group" style="display:inline-block;">
                          ...
                          <div class="box-footer" style="width:93%;">
                            ...
                            <a type="button" class="btn btn-info" style="width:15%;margin-right:19%" href="<?= base_url('admin/tabel_barangproduksi') ?>" name="btn_listsatuan"><i class="fa fa-table" aria-hidden="true"></i> Lihat Barang Produksi</a>
